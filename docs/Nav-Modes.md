...
| **Cool** | Σχέδιο 1a «Κάθετες κολόνες» με τις προσαρμογές του Γιώργου (αποχρώσεις πορτοκαλί, συμπληρωματικά αριστερά περιγράμματα, liquid-glass, συμπίεση δεξιά στο scroll). **Εκκρεμεί — προς το παρόν πέφτει στο Modern.** Στο κινητό πάντα Modern. | `components/nav/CoolNav.tsx` (θα δημιουργηθεί) |
