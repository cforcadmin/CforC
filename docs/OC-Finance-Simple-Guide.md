...
sequenceDiagram
    ...
    OC-->>G: Ενεργοποιείται το «Αποστολή»
    G->>OC: Πατά «Αποστολή»
...
> **Παράδειγμα.** Την 1η Οκτωβρίου η Ταμίας πατά «Έτοιμο» για τον Σεπτέμβριο. Στις 2/10 η Γραμματεία πατά «Αποστολή». Η λογίστρια λαμβάνει email: «Σεπτέμβριος 2026 — Έσοδα 1.240,00 € (7 γραμμές) · Έξοδα 618,40 € (5 γραμμές) · Ισοζύγιο +621,60 €», ένα τμήμα Γ με το 8.7 της Ντόβα, το CSV συνημμένο, και δύο συνδέσμους «φάκελος Εξόδων · φάκελος Εσόδων». Το finance@ και το hello@ παίρνουν κοινοποίηση.
