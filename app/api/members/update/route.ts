...
export async function POST(request: NextRequest) {
  try {
    ...
    // Η εγγραφή στο newsletter (Strapi + Sender «Paid») ΔΕΝ γίνεται πια εδώ.
    // Γινόταν στην πρώτη ενημέρωση προφίλ, όσο η φωτογραφία ερχόταν με email
    // και το προφίλ άνοιγε μόνο με επέμβαση του μέλους. Πλέον η αίτηση φέρνει
    // τα πάντα, οπότε το μέλος μπαίνει στο newsletter τη στιγμή που
    // επιβεβαιώνεται η πληρωμή — δες lib/newsletterMembers.ts.
