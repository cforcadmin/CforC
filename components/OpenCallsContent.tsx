  ...
  return (
    <section className="py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Filter Bar */}
        <div className={cool ? 'relative z-30 menu-glass glass-rim rounded-3xl p-6 md:p-8 mb-12' : 'relative z-30 bg-white dark:bg-gray-800 rounded-3xl p-6 md:p-8 mb-12 shadow-sm'}>
