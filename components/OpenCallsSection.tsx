    ...
    >
      ...
      >
        ...
        <div className="[backface-visibility:hidden] w-full h-full">
          <Wrapper
            {...wrapperProps as any}
            className={`menu-glass card-liquid card-liquid-hover rounded-3xl overflow-hidden flex flex-col h-full text-left ${expired ? 'opacity-75' : ''}`}
        ...
        <div ref={backRef} className="absolute top-0 left-0 w-full [backface-visibility:hidden] [transform:rotateY(180deg)]">
          <Wrapper
            {...wrapperProps as any}
            className={`menu-glass card-liquid card-liquid-featured rounded-3xl overflow-hidden flex flex-col text-left ${expired ? 'opacity-75' : ''}`}
