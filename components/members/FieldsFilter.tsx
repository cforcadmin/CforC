...
export default function FieldsFilter({
  ...
  const rowOff = 'menu-row-off text-charcoal dark:text-gray-100'
      ...
      {isOpen && (
        <div className={compact
          ...
          <div className={panelCls}>
            <div className={`${compact ? 'px-3 py-1.5' : 'px-3 py-2'} border-b menu-divider flex items-center justify-between`}>
          ...
          {hoveredCategory !== null && (
            ...
            >
              <div className={`${compact ? 'px-3 py-1.5' : 'px-3 py-2'} border-b menu-divider`}>
                ...
                if (splittable) {
                  return (
                    <div key={subIndex}>
                      ...
                      {/* Expanded checkboxes */}
                      {isExpanded && (
                        <div className="px-4 py-2 bg-black/5 dark:bg-white/5 border-y menu-divider">
