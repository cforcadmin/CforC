    ...
    >
      ...
      >
        ...
        <div className="[backface-visibility:hidden] w-full h-full">
          <Link
            href={href}
            className="bg-white dark:bg-gradient-to-r dark:from-gray-800 dark:to-gray-900 rounded-3xl overflow-hidden shadow-sm hover:shadow-xl dark:hover:shadow-gray-700/50 transition-shadow duration-300 border-l-4 border-transparent hover:border-coral dark:hover:border-coral-light flex flex-col h-full"
          >
            {imageUrl ? (
        ...
        <div className="absolute top-0 left-0 w-full h-full [backface-visibility:hidden] [transform:rotateY(180deg)]">
          <Link
            href={href}
            className="bg-white dark:bg-gradient-to-r dark:from-gray-800 dark:to-gray-900 rounded-3xl overflow-hidden shadow-xl dark:shadow-gray-700/50 border-l-4 border-coral dark:border-coral-light flex flex-col h-full"
          >
