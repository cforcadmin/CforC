// Το σώμα της σελίδας, κοινό για Classic/Modern ΚΑΙ για την όψη του
// ενιαίου ΠΟΛΙΤΙΚΗ στο Cool (PolicyCoolPage). Εξήχθη αυτούσιο 29/8/26.
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none text-gray-700 dark:text-gray-300">
            ...
            <h3 className="text-2xl font-bold mb-4 mt-12 text-charcoal dark:text-coral-light">Αυτός ο ιστότοπος χρησιμοποιεί cookies</h3>
            ...
            <h3 className="text-2xl font-bold mb-4 mt-12 text-charcoal dark:text-coral-light">Ποια είναι η έννοια των cookies</h3>
            ...
            <h3 className="text-2xl font-bold mb-4 mt-12 text-charcoal dark:text-coral-light">Κάνουμε χρήση Cookies,</h3>
            ...
            <h3 className="text-2xl font-bold mb-4 mt-12 text-charcoal dark:text-coral-light">Πώς να ελέγξετε και να διαγράψετε τα cookies</h3>
            ...
            <h3 className="text-2xl font-bold mb-4 mt-12 text-charcoal dark:text-coral-light">Απολύτως Απαραίτητα Cookies</h3>
            ...
            <h3 className="text-2xl font-bold mb-4 mt-12 text-charcoal dark:text-coral-light">Στατιστικά Cookies</h3>
