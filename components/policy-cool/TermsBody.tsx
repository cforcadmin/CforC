  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none text-gray-700 dark:text-gray-300">
            <h2 className="text-3xl font-bold mb-4 text-charcoal dark:text-gray-100">ΟΡΟΙ ΧΡΗΣΗΣ</h2>
            ...
            <p className="mb-6 leading-relaxed">
              ...
              (εφεξής "ο δικτυακός τόπος") ανήκει νομικά στον μη κερδοσκοπικό οργανισμό (σωματείο) "Culture For Change" (εφεξής "CforC"), που εδρεύει στην Αθήνα, Ελλάδα (οδού Λ. Αλεξάνδρας 48, ΤΚ 11473).
            </p>
            ...
            <h3 className="text-2xl font-bold mb-4 mt-12 text-charcoal dark:text-coral-light">1. ΔΙΚΑΙΩΜΑΤΑ ΠΝΕΥΜΑΤΙΚΗΣ ΙΔΙΟΚΤΗΣΙΑΣ</h3>
            <p className="mb-6 leading-relaxed">
            ...
            <h3 className="text-2xl font-bold mb-4 mt-12 text-charcoal dark:text-coral-light">3. ΥΠΟΧΡΕΩΣΕΙΣ ΤΟΥ ΧΡΗΣΤΗ</h3>
            <p className="mb-6 leading-relaxed">
            ...
            <h3 className="text-2xl font-bold mb-4 mt-12 text-charcoal dark:text-coral-light">4. ΕΞΩΤΕΡΙΚΟΙ ΣΥΝΔΕΣΜΟΙ</h3>
            <p className="mb-12 leading-relaxed">
            ...
            <h3 className="text-2xl font-bold mb-4 mt-12 text-charcoal dark:text-coral-light">5. NEWSLETTER</h3>
            <p className="mb-12 leading-relaxed">
              ...
              μας αναφέρουμε αναλυτικά και τις διαδικασίες προστασίας των Προσωπικών δεδομένων των χρηστών που εγγράφονται στο newsletter μας.
            </p>

            <h3 className="text-2xl font-bold mb-4 mt-12 text-charcoal dark:text-coral-light">6. ΣΥΛΛΟΓΗ ΚΑΙ ΕΠΕΞΕΡΓΑΣΙΑ ΔΕΔΟΜΕΝΩΝ ΠΡΟΣΩΠΙΚΟΥ ΧΑΡΑΚΤΗΡΑ</h3>
            <p className="mb-6 leading-relaxed">
            ...
            <h3 className="text-2xl font-bold mb-4 mt-12 text-charcoal dark:text-coral-light">7. ΠΟΛΙΤΙΚΗ ΓΙΑ ΧΡΗΣΗ COOKIES</h3>
            <p className="mb-12 leading-relaxed">
            ...
            <h3 className="text-2xl font-bold mb-4 mt-12 text-charcoal dark:text-coral-light">8. ΑΛΛΑΓΗ ΠΕΡΙΕΧΟΜΕΝΟΥ</h3>
            <p className="mb-6 leading-relaxed">
              Οι Όροι Χρήσης αλλά και η{' '}
              <Link href="/privacy" className="text-charcoal dark:text-coral-light hover:underline font-bold">
                Πολιτική Απορρήτου
              </Link>{' '}
              επικαιροποιήθηκαν τον Ιανουάριο του 2026.
            </p>
            <p className="mb-12 leading-relaxed">
